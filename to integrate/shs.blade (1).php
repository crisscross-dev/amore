                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="last_name" name="last_name" value="{{ old('last_name') }}" placeholder="Enter your family name" required>
                                            @error('last_name')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name') }}" placeholder="Enter your given name" required>
                                            @error('first_name')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="middle_name" name="middle_name" value="{{ old('middle_name') }}" placeholder="Enter your middle name (optional)">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="citizenship" value="{{ old('citizenship') }}" placeholder="e.g., Filipino" required>
                                            @error('citizenship')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="religion" value="{{ old('religion') }}" placeholder="e.g., Catholic, Protestant, Muslim" required>
                                            @error('religion')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="height" value="{{ old('height') }}" step="0.01" placeholder="e.g., 165.5" required>
                                            @error('height')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="weight" value="{{ old('weight') }}" step="0.01" placeholder="e.g., 55.5" required>
                                            @error('weight')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="09XXXXXXXXX" maxlength="11" pattern="^09\d{9}$" title="Enter an 11-digit Philippine mobile number starting with 09" required>
                                            @error('phone')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="mother_name" value="{{ old('mother_name') }}" placeholder="Enter mother's maiden name" required>
                                            @error('mother_name')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="mother_occupation" value="{{ old('mother_occupation') }}" placeholder="e.g., Teacher, Nurse, Business Owner" required>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Occupation <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="father_occupation" value="{{ old('father_occupation') }}" placeholder="e.g., Engineer, Driver, Self-employed" required>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="emergency_contact_name" value="{{ old('emergency_contact_name') }}" placeholder="Enter emergency contact name" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="emergency_contact_relationship" value="{{ old('emergency_contact_relationship') }}" placeholder="e.g., Mother, Father, Guardian" required>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Phone Number <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="emergency_contact_phone" value="{{ old('emergency_contact_phone') }}" placeholder="09XXXXXXXXX" maxlength="11" pattern="^09\d{9}$" title="Enter an 11-digit Philippine mobile number starting with 09" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    escRadio?.addEventListener('change', function () {
        ...
        qvrApplicant.value = '';
        document.getElementById('qvr_number').value = '';
    });

    // Show QVR Number only if Yes
...
// Auto-format QVR Number as Q25-MV5RCSP4, works for typing or pasting
