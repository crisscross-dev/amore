        ...
        <div class="faculty-management-card p-4">
          <form action="{{ route('faculty.grades.store') }}" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="student_id" id="studentSelect" class="form-select" required>
                ...
                @foreach($students as $student)
                  <option value="{{ $student->id }}" data-section="{{ $student->section_id }}" {{ (int) old('student_id') === $student->id ? 'selected' : '' }}>
            ...
            <div class="col-md-6">
              ...
              <input type="number" step="0.01" min="0" max="100" name="grade_value" class="form-control" required>
            </div>
