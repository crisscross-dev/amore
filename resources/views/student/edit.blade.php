...
<!-- Student Edit Profile CSS -->
@vite(['resources/css/student/dashboard-student-edit.css'])
                            ...
                            <p class="text-muted mb-0">Update your personal information and settings</p>
                                <div class="mt-2">
                                    <span class="badge bg-success text-white">
                                        ...
                                        {{ Auth::user()->grade_level ?? 'Grade level pending' }}
                                    </span>
                                </div>
                        </div>
                        <x-ui.button variant="warning" href="{{ route('dashboard.student') }}" class="mt-3 mt-md-0">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-form.select 
                                            ...
                                            :selected="old('grade_level', Auth::user()->grade_level)"
                                            disabled
                                        />
                                        <small class="text-muted">
                                            <i class="fas fa-lock me-1"></i>Grade level cannot be changed
                                        </small>
                                    </div>

                                    <!-- LRN (Learner's Reference Number) -->
                                    <div class="col-md-6">
                                        <x-form.label for="lrn">
                                            <i class="fas fa-id-card-alt me-1"></i>LRN (Learner's Reference Number)
                                        </x-form.label>
                                        <x-form.input 
                                            id="lrn" 
                                            name="lrn" 
                                            :value="old('lrn', Auth::user()->lrn)"
                                            placeholder="12-digit LRN"
                                            maxlength="12"
                                            disabled
                                        />
                                        <small class="text-muted">
                                            <i class="fas fa-lock me-1"></i>LRN cannot be changed
                                        </small>
                                    </div>
                                </div>
                            </div>
