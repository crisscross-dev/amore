...
<div id="student-calendar-page" class="dashboard-container" data-calendar-month="{{ $currentMonth }}" data-calendar-year="{{ $currentYear }}" data-live-url="{{ route('calendar.live-signature') }}" data-live-signature="{{ $calendarLiveSignature }}">
