...
@section('title', 'Create Faculty Position - Admin Dashboard - Amore Academy')
        ...
        <div class="row">
            ...
            <main class="col-12">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7">
                            ...
                            <p class="mb-0 opacity-90">
                                Define a new role that administrators can assign to faculty members.
                            </p>
                        </div>
                        <div class="col-lg-5">
                ...
                <div class="faculty-management-card">
                    ...
                    <form action="{{ route('admin.faculty-positions.store') }}" method="POST" class="row g-4">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="e.g., PRINCIPAL" required>
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="hierarchy_level" class="form-control @error('hierarchy_level') is-invalid @enderror" value="{{ old('hierarchy_level', 5) }}" min="1" max="15" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Describe responsibilities and scope">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
