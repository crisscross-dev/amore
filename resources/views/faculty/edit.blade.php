...
@section('title', 'Edit Profile - Faculty Dashboard - Amore Academy')
                    ...
                    <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted">
                                            <i class="fas fa-lock me-1"></i>Employee ID cannot be changed
                                        </small>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="profile-form-card">
                                ...
                                <h5 class="mb-4">
                                    <i class="fas fa-user-tie me-2"></i>Position Assignment
                                </h5>

                                @php
                                    $currentUser = Auth::user();
                                    $position = optional($currentUser->facultyPosition);
                                    $assigner = optional($currentUser->positionAssignee);
                                    $assignedDate = $currentUser->position_assigned_date
                                        ? \Illuminate\Support\Carbon::parse($currentUser->position_assigned_date)->format('M d, Y')
                                        : '—';
                                    $assignedBy = $assigner->first_name
                                        ? trim($assigner->first_name . ' ' . ($assigner->last_name ?? ''))
                                        : '—';
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-xl-3">
                                        <x-form.label for="current_position">
                                            <i class="fas fa-user-tie me-1"></i>Current Position
                                        </x-form.label>
                                        <input
                                            type="text"
                                            id="current_position"
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <x-form.label for="current_department">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <x-form.label for="assigned_on">
                                            <i class="fas fa-calendar-check me-1"></i>Assigned On
                                        </x-form.label>
                                        <input
                                            type="text"
                                            id="assigned_on"
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <x-form.label for="assigned_by">
                                            <i class="fas fa-user-shield me-1"></i>Assigned By
                                        </x-form.label>
                                        <input
                                            type="text"
                                            id="assigned_by"
                                ...
                                <div class="alert alert-warning border-0 mt-3 mb-0">
                                    ...
                                    Position and department assignments are managed by the administration team.
                                </div>
                            </div>
                        </div>
